...
#define TUN_FLOWCTL_MINOR MISC_DYNAMIC_MINOR 
...
static netdev_tx_t tun_net_xmit(struct sk_buff *skb, struct net_device *dev)
{
	...
	if (skb_queue_len(&tfile->socket.sk->sk_receive_queue) * numqueues
		 ...
		 * over error is more appropriate.
		*/
			   ...
			   int noblock)
{
	...
	if (netif_tx_queue_stopped(ntxq))
...
static struct miscdevice tun_miscdev = {
	.minor = TUN_FLOWCTL_MINOR,
	.name = "tun_flowctl",
	.nodename = "net/tun_flowctl",
	.fops = &tun_fops,
};
...
struct socket *tun_flowctl_get_socket(struct file *file)
{
	struct tun_file *tfile;
...
EXPORT_SYMBOL_GPL(tun_flowctl_get_socket);
...
MODULE_LICENSE("GPL");
MODULE_ALIAS_MISCDEV(TUN_FLOWCTL_MINOR);
MODULE_ALIAS("devname:net/tun_flowctl");
